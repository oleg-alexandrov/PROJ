...
geodetic coordinates for a single coordinate system. Explanations for specific
...
coordinates to a custom definition of a map projection. An example of this shown
...
An example illustrating :c:func:`proj_create`, which, for a given coordinate system, converts between projected and geographic coordinates:
